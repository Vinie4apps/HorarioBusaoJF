package com.vinie4apps.horariobusaojf.Itens.itemVERMELHO;
...
public class Horarios_Adapter_red extends PagerAdapter {

    private List<Horarios_Model_red> models;
    ...
    public Horarios_Adapter_red(List<Horarios_Model_red> models, Context context) {
        this.models = models;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view = layoutInflater.inflate(R.layout.itemvermelho, container, false);
