...
public class Chat_linha117 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("117 - V.da Serra/via G.Dilerm. Chat");
        ...
        messagedb = database.getReference("Geral/linha117");
    ...
    private void verifyAuthentication() {
        ...
        if (FirebaseAuth.getInstance().getUid() == null) {
            Intent intent = new Intent(Chat_linha117.this, login.class);
    ...
    private void displayMessages(List<Message> messages) {
        ...
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Chat_linha117.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setStackFromEnd(true);
        messageAdapter = new MessageAdapter(Chat_linha117.this,messages,messagedb);
