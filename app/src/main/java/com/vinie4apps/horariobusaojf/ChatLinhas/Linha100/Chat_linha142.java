...
public class Chat_linha142 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("142 - Band./Bela Au. Chat");
        ...
        messagedb = database.getReference("Geral/linha142");
    ...
    private void verifyAuthentication() {
        ...
        if (FirebaseAuth.getInstance().getUid() == null) {
            Intent intent = new Intent(Chat_linha142.this, login.class);
    ...
    private void displayMessages(List<Message> messages) {
        ...
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Chat_linha142.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setStackFromEnd(true);
        messageAdapter = new MessageAdapter(Chat_linha142.this,messages,messagedb);
