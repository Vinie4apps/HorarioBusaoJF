...
public class Chat_linha105 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("105 - Filgueiras Chat ");
        ...
        messagedb = database.getReference("Geral/linha105");
    ...
    private void verifyAuthentication() {
        ...
        if (FirebaseAuth.getInstance().getUid() == null) {
            Intent intent = new Intent(Chat_linha105.this, login.class);
    ...
    private void displayMessages(List<Message> messages) {
        ...
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Chat_linha105.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setStackFromEnd(true);
        messageAdapter = new MessageAdapter(Chat_linha105.this,messages,messagedb);
