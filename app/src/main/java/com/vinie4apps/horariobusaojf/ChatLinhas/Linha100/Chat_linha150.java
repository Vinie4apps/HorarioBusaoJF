...
public class Chat_linha150 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("150 - Grama Chat");
        ...
        messagedb = database.getReference("Geral/linha150");
    ...
    private void verifyAuthentication() {
        ...
        if (FirebaseAuth.getInstance().getUid() == null) {
            Intent intent = new Intent(Chat_linha150.this, login.class);
    ...
    private void displayMessages(List<Message> messages) {
        ...
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Chat_linha150.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setStackFromEnd(true);
        messageAdapter = new MessageAdapter(Chat_linha150.this,messages,messagedb);
