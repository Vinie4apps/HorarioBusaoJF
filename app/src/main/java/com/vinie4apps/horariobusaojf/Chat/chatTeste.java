...
public class chatTeste extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        u.setUid(currentuser.getUid());
            ...
            messagedb = database.getReference("Geral/linhateste");
    ...
    private void verifyAuthentication() {
        ...
        if (FirebaseAuth.getInstance().getUid() == null) {
            Intent intent = new Intent(chatTeste.this, login.class);
    ...
    private void displayMessages(List<Message> messages) {
        ...
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(chatTeste.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setStackFromEnd(true);
        messageAdapter = new MessageAdapter(chatTeste.this,messages,messagedb);
